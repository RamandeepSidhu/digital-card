...
export default function EditBankCardPage() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const formData: BankCardFormData = {
            ...
            bankName: card.data.bankName,
            accountNumber: card.data.accountNumber,
            ifscCode: card.data.ifscCode || '',
            routingNumber: card.data.routingNumber || '',
            upiId: card.data.upiId || '',
            logo: card.data.logo || '',
            style: card.style,
          };
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-400">
              {currentStep === 'form' && 'Update your bank information'}
